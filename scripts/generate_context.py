...
This script is based on https://github.com/NII-DG/nii-dg/blob/main/schema/scripts/generate_context.py
Version 1.0.3.
...
# please replace this with your repo string.
THIS_REF: str = "main"

# please replace this with your repo string.
THIS_REPO: str = "hirakinii/nii_dg_test_schema"
...
def main(args: List[str]) -> None:
    ...
    try:
        ...
        ctx = generate_ctx(schema, THIS_REPO, THIS_REF, schema_name)
